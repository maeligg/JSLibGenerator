...
// Words arrays
const verbs = ['pixelify', 'rasterize', 'vectorize', 'optimize', 'package', 'minify', 'unminify', 'uglify', 'prettify', 'componentize', 'inject', 'transpile', 'unit test', 'curry', 'lint', 'unit test', 'concatenate', 'compile', 'cache', 'embed', 'templatize', 'audit', 'prototype', 'modularize', 'debug', 'import', 'export', 'polyfill', 'normalize', 'shrink', 'awesomize', 'randomize'];
